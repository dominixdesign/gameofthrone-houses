<template>
  <div v-if="showDefinition()" class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border-b border-gray-100">
    <dt class="text-sm font-medium text-gray-800 font-medieval">
      {{ defTitle }}
    </dt>
